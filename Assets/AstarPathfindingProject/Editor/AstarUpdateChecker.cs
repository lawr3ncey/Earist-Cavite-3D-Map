...
namespace Pathfinding {
	...
	public static class AstarUpdateChecker {
        ...
        /// </summary>
        static readonly Dictionary<string, string> astarServerData = new()
        {
		...
		public static string GetURL (string tag) {
			RefreshServerMessage();
            astarServerData.TryGetValue("URL:" + tag, out string url);
            return url ?? "";
		}
		...
		static void ShowUpdateWindowIfRelevant () {
			...
			try {
                ...
                if (LatestVersion == remindVersion && System.DateTime.TryParse(EditorPrefs.GetString("AstarRemindUpdateDate", "1/1/1971 00:00:01"), out System.DateTime remindDate)) {
